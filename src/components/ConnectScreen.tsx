...
import { VENDORS, type CameraInfo, type Vendor } from "../lib/types";
  ...
  return (
    <form className="connect" onSubmit={connect}>
      ...
      <p className="connect__footnote">
        The camera and this device have to be on the same network. Canon bodies
        also need CCAPI enabled before they answer at all.
      </p>
    </form>
  );
}
